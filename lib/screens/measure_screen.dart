...
class _MeasurescreenState extends State<Measurescreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(
                        color: selectedMeasurement == '음주' || selectedMeasurement == '체취'
                            ? const Color(0xFF3B82F6)
                            : Colors.transparent,
                        width: 2,
                      ),
      ...
      bottomNavigationBar: CustomBottomNavigationBar( // 여기서 호출
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10),
          side: BorderSide(
            color: selectedBodyOdor == '$title 체취'
                ? const Color(0xFF3B82F6)
                : Colors.transparent,
            width: 2,
          ),
            ...
            child: Column(
              ...
              children: [
                const CircularProgressIndicator(
                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF3B82F6)), // 로딩 인디케이터 색상
                ),
                const SizedBox(height: 20),
                Text(
                  "센서인식중...",
